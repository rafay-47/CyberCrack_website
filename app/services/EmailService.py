...
"""
    ...
    def send_admin_license_email(self, to_email, to_name, license_key, order_id, valid_days=30):
        """
        Send an email containing the license key for admin-generated licenses
        """
        # Validate email before sending
        is_valid, message = self.validate_email(to_email)
        if not is_valid:
        ...
        subject = "Your CyberCrack License Key (Admin Generated)"
        
        # Plain text version of the email
        text_content = f"""
Hello {to_name},

Your CyberCrack license has been generated by an administrator.
...
Your license is valid for {valid_days} days from today. If you have any questions or need assistance, please contact our support team at cybercrack@sbmtechpro.com.
...
<head>
    <style>
        ...
        .license-box {{ background: #e8f5e8; border: 2px solid #4CAF50; padding: 15px; margin: 20px 0; border-radius: 5px; }}
        .license-key {{ font-family: monospace; font-size: 16px; font-weight: bold; word-break: break-all; }}
        .admin-badge {{ background: #ff9800; color: white; padding: 3px 8px; border-radius: 3px; font-size: 12px; }}
        .instructions {{ background: white; padding: 15px; border-left: 4px solid #2196F3; margin: 20px 0; }}
...
<body>
    <div class="container">
        <div class="header">
            <h1>🔐 CyberCrack License</h1>
            <span class="admin-badge">ADMIN GENERATED</span>
        </div>
        
        <div class="content">
            <h2>Hello {to_name},</h2>
            <p>Your CyberCrack license has been generated by an administrator.</p>
            
            <div class="license-box">
                <h3>📝 License Details</h3>
                <p><strong>License Key:</strong><br>
                <span class="license-key">{license_key}</span></p>
                <p><strong>Order ID:</strong> {order_id}</p>
                <p><strong>Valid for:</strong> {valid_days} days</p>
            </div>
            ...
            <p>If you have any questions or need assistance, please contact our support team at <a href="mailto:cybercrack@sbmtechpro.com">cybercrack@sbmtechpro.com</a>.</p>
        </div>
        
        <div class="footer">
            <p>Thank you for choosing CyberCrack!</p>
            <p><a href="https://getcybercrack.com/">Visit our website</a></p>
        </div>
    </div>
</body>
</html>
